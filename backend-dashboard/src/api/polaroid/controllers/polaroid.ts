...
export default ({ strapi }: { strapi: Core.Strapi }) => {
  async function logPolaroidActivity(
    ...
    // Audit records are OpenTelemetry log records now, not Strapi rows.
    recordAudit({
      action,
  ...
  return {
    ...
    async uploadAsset(ctx: Context) {
      ...
      try {
        ...
        if (!file) {
          ctx.throw(
            400,
            'No file provided. Send file as "assetData" field in multipart/form-data.',
          );
        }
    ...
    async deleteAssets(ctx: Context) {
      ...
      try {
        ...
        await logPolaroidActivity("polaroid.delete", user.id, {
          ids: payload.ids,
          force: payload.force,
        });
        ctx.status = 204;
    ...
    async getAssetThumbnail(ctx: Context) {
      ...
      try {
        ...
        const response = await service.getAssetThumbnail(
          user.id,
          ctx.params.assetId,
          size,
        );
    ...
    async checkExistingAssets(ctx: Context) {
      ...
      try {
        ...
        const service = strapi.service("api::polaroid.polaroid");
        ctx.body = await service.checkExistingAssets(
          user.id,
          body.deviceAssetIds,
          body.deviceId,
        );
    ...
    async getTimeBuckets(ctx: Context) {
      ...
      try {
        ...
        ctx.body = await service.getTimeline(
          user.id,
          ctx.query as Parameters<typeof service.getTimeline>[1],
        );
      } catch (error) {
        handleError(ctx, error);
      }
    ...
    async getTimeBucket(ctx: Context) {
      ...
      try {
        ...
        ctx.body = await service.getTimeBucket(
          user.id,
          ctx.query as Parameters<typeof service.getTimeBucket>[1],
        );
      } catch (error) {
        handleError(ctx, error);
      }
    ...
    async getAlbums(ctx: Context) {
      ...
      try {
        const service = strapi.service("api::polaroid.polaroid");
        const shared =
          ctx.query.shared !== undefined
            ? ctx.query.shared === "true"
            : undefined;
    ...
    async createAlbum(ctx: Context) {
      ...
      try {
        ...
        const album = await service.createAlbum(
          user.id,
          ctx.request.body as Parameters<typeof service.createAlbum>[1],
        );
        await logPolaroidActivity(
          "polaroid.album.create",
          user.id,
          {},
          (ctx.request.body as { albumName?: string })?.albumName,
        );
        ctx.body = album;
      } catch (error) {
        handleError(ctx, error);
    ...
    async updateAlbum(ctx: Context) {
      ...
      try {
        ...
        const updatedAlbum = await service.updateAlbum(
          user.id,
          ctx.params.albumId,
          ctx.request.body as Parameters<typeof service.updateAlbum>[2],
        );
        await logPolaroidActivity("polaroid.album.update", user.id, {
    ...
    async deleteAlbum(ctx: Context) {
      ...
      try {
        ...
        await logPolaroidActivity("polaroid.album.delete", user.id, {
          albumId: ctx.params.albumId,
        });
        ctx.status = 204;
        ctx.body = null;
    ...
    async addAlbumAssets(ctx: Context) {
      ...
      try {
        ...
        const service = strapi.service("api::polaroid.polaroid");
        ctx.body = await service.addAssetsToAlbum(
          user.id,
          ctx.params.albumId,
          body.ids,
        );
    ...
    async removeAlbumAssets(ctx: Context) {
      ...
      try {
        const body = ctx.request.body as { ids: string[] };
        const service = strapi.service("api::polaroid.polaroid");
        ctx.body = await service.removeAssetsFromAlbum(
          user.id,
          ctx.params.albumId,
          body.ids,
        );
    ...
    async getPeople(ctx: Context) {
      ...
      try {
        ...
        ctx.body = await service.getPeople(
          user.id,
          ctx.query as Parameters<typeof service.getPeople>[1],
        );
      } catch (error) {
        handleError(ctx, error);
      }
    ...
    async updatePerson(ctx: Context) {
      ...
      try {
        ...
        ctx.body = await service.updatePerson(
          user.id,
          ctx.params.personId,
          ctx.request.body as Parameters<typeof service.updatePerson>[2],
        );
      } catch (error) {
        handleError(ctx, error);
      }
    ...
    async mergePeople(ctx: Context) {
      ...
      try {
        const body = ctx.request.body as { ids: string[] };
        const service = strapi.service("api::polaroid.polaroid");
        ctx.body = await service.mergePeople(
          user.id,
          ctx.params.personId,
          body.ids,
        );
    ...
    async searchMetadata(ctx: Context) {
      ...
      try {
        ...
        ctx.body = await service.searchAssets(
          user.id,
          ctx.request.body as Parameters<typeof service.searchAssets>[1],
        );
      } catch (error) {
        handleError(ctx, error);
      }
    ...
    async getMapMarkers(ctx: Context) {
      ...
      try {
        ...
        ctx.body = await service.getMapMarkers(
          user.id,
          ctx.query as Parameters<typeof service.getMapMarkers>[1],
        );
      } catch (error) {
        handleError(ctx, error);
      }
    ...
    async createSharedLink(ctx: Context) {
      ...
      try {
        const service = strapi.service("api::polaroid.polaroid");
        ctx.status = 201;
        const sharedLink = await service.createSharedLink(
          user.id,
          ctx.request.body as Parameters<typeof service.createSharedLink>[1],
        );
    ...
    async updateSharedLink(ctx: Context) {
      ...
      try {
        ...
        ctx.body = await service.updateSharedLink(
          user.id,
          ctx.params.linkId,
          ctx.request.body as Parameters<typeof service.updateSharedLink>[2],
        );
      } catch (error) {
        handleError(ctx, error);
      }
    ...
    async deleteSharedLink(ctx: Context) {
      ...
      try {
        ...
        await logPolaroidActivity("polaroid.share.delete", user.id, {
    ...
    async createTag(ctx: Context) {
      ...
      try {
        const service = strapi.service("api::polaroid.polaroid");
        ctx.status = 201;
        ctx.body = await service.createTag(
          user.id,
          ctx.request.body as Parameters<typeof service.createTag>[1],
        );
      } catch (error) {
        handleError(ctx, error);
      }
    ...
    async updateTag(ctx: Context) {
      ...
      try {
        ...
        ctx.body = await service.updateTag(
          user.id,
          ctx.params.tagId,
          ctx.request.body as Parameters<typeof service.updateTag>[2],
        );
      } catch (error) {
        handleError(ctx, error);
      }
    ...
    async untagAssets(ctx: Context) {
      ...
      try {
        const body = ctx.request.body as { ids: string[] };
        const service = strapi.service("api::polaroid.polaroid");
        ctx.body = await service.untagAssets(
          user.id,
          ctx.params.tagId,
          body.ids,
        );
    ...
    async runJob(ctx: Context) {
      ...
      try {
        ...
        await logPolaroidActivity("polaroid.job.run", user.id, {
    ...
    async restoreAssets(ctx: Context) {
      ...
      try {
        ...
        await logPolaroidActivity("polaroid.trash.restore", user.id, {
          count: ids.length,
        });
        ctx.status = 204;
        ctx.body = null;
    ...
    async getSharedLinkAssetThumbnail(ctx: Context) {
      try {
        ...
        const service = strapi.service("api::polaroid.polaroid");
        const response = await service.getSharedLinkAssetThumbnail(
          key,
          assetId,
          size,
          password,
    ...
    async getSharedLinkAssetOriginal(ctx: Context) {
      try {
        ...
        const service = strapi.service("api::polaroid.polaroid");
        const response = await service.getSharedLinkAssetOriginal(
          key,
          assetId,
          password,
        );
