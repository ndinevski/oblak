...
export interface ApiFunctionFunction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    environment: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<{}>;
    externalId: Schema.Attribute.String & Schema.Attribute.Private;
    handler: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'index.handler'>;
    invocationCount: Schema.Attribute.BigInteger &
      Schema.Attribute.DefaultTo<'0'>;
    lastInvokedAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    runtime: Schema.Attribute.Enumeration<
      ['nodejs20', 'nodejs18', 'python312', 'python311', 'dotnet8', 'dotnet7']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'nodejs20'>;
    status: Schema.Attribute.Enumeration<
      ['active', 'inactive', 'error', 'deploying']
    > &
      Schema.Attribute.DefaultTo<'inactive'>;
    tags: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    timeoutSec: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 900;
          min: 1;
